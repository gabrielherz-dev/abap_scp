class zcl_datagen_libros_herz definition
...
class zcl_datagen_libros_herz implementation.

method if_oo_adt_classrun~main.

 data: lt_acc_categ type table of ztb_acc_cat_herz ,

 lt_catego type table of ztb_catego_herz,

 lt_clientes type table of ztb_client_herz,

 lt_clnts_lib type table of ztb_clnt_li_herz,

 lt_libros type table of ztb_libros_herz.
...
******** ztb_acc_cat_herz  ********
 ...
 delete from ztb_acc_cat_herz .

 insert ztb_acc_cat_herz  from table @lt_acc_categ.
...
******** ztb_catego_herz ********
 ...
 delete from ztb_catego_herz.

 insert ztb_catego_herz from table @lt_catego.
...
******** ztb_client_herz ********
 ...
 delete from ztb_client_herz.

 insert ztb_client_herz from table @lt_clientes.
...
******** ztb_clnt_li_herz
 ...
 delete from ztb_clnt_li_herz.

 insert ztb_clnt_li_herz from table @lt_clnts_lib.
...
******** ztb_libros_herz ********
 ...
 delete from ztb_libros_herz.

 insert ztb_libros_herz from table @lt_libros.
