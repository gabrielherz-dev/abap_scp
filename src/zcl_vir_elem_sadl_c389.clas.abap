CLASS zcl_vir_elem_sadl_c389 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_vir_elem_sadl_c389 IMPLEMENTATION.

  METHOD if_sadl_exit_calc_element_read~calculate.

    DATA lt_original_data TYPE STANDARD TABLE OF ztravel_c_c389 WITH DEFAULT KEY.
